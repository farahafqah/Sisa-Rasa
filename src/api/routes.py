...
# Note: The /api/analytics/leftover-ingredients route has been moved to analytics_routes.py
# to avoid duplicate route definitions and ensure proper Flask app context handling.
